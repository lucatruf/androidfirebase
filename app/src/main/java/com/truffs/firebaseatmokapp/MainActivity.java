...
public class MainActivity extends ActionBarActivity
        implements NavigationDrawerFragment.NavigationDrawerCallbacks,
                    ...
                    DeviceItemFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Attempt login
        fbRef.authWithPassword(intent.getStringExtra("EMAIL"), intent.getStringExtra("PASS"), new Firebase.AuthResultHandler() {
            @Override
        ...
        switch (position) {
            case 0:
                fragmentManager.beginTransaction()
                        .replace(R.id.container, new DeviceItemFragment())
                        .commit();
                break;
            case 1:
                fragmentManager.beginTransaction()
                        .replace(R.id.container, new HistoryItemFragment())
                        .commit();
                break;
            default:
                fragmentManager.beginTransaction()
